...
import styles from './DesktopsBreadcrumb.module.css';
import { getSeriesItems, getFeatures } from '../../../MockData/DesktopMockData';

const DesktopsBreadcrumb = ({ category, subcategory, series, productCount }) => {
        ...
        <div className={styles.topboxLeft}>
          <h2 className={styles.topboxTitle}>
            {series ? getSeriesName(series) : 
             ...
             category || 'All Desktops'} ({productCount})
          </h2>
            ...
            <ol className={styles.breadcrumbList}>
              ...
              {subcategory && (
                <li className={styles.breadcrumbItem}>
                  <Link 
                    className={styles.breadcrumbLink} 
                    to={`/desktops?category=${category}&subcategory=${subcategory}`}
                  >
              ...
              {series && (
                <li className={styles.breadcrumbItem}>
                  <Link 
                    className={styles.breadcrumbLink} 
                    to={`/desktops?category=${category}&series=${series}`}
                  >
...
export default DesktopsBreadcrumb;