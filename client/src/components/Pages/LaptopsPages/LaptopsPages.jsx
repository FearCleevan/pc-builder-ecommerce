// client/src/components/Pages/LaptopsPages/LaptopsPages.jsx (updated filtering logic)
import React, { useState, useEffect, useMemo } from 'react';
import { useSearchParams } from 'react-router-dom';
import LaptopsFilter from './LaptopsFilter/LaptopsFilter';
...
const LaptopsPages = () => {
    const [allProducts] = useState([...laptopProducts]);
                ...
                <div className={styles.content}>
                    ...
                    <main className={styles.mainContent}>
                        ...
                        <div className={`${styles.productsContainer} ${isMobileFilterOpen ? styles.productsShifted : ''}`}>
                            <LaptopsGrid products={paginationData.currentItems} />
