        ...
        <div className={styles.dropdownContainer} ref={dropdownRef}>
          ...
          >
            <div className={styles.dropdownButtonContent}>
              {/* Show the selected icon if available, otherwise fallback */}
              {componentType?.icon ? (
                <span className={styles.icon}>{componentType.icon}</span>
              ) : (
                <svg
                ...
                >
                  <path
                    d="M12.64 24.59c-.3-.28-.47-.68-.47-1.09V2.56c-2.38.18-4.26 2.15-4.26 4.58v35.71a4.6 4.6 0 0 0 4.6 4.6h3.13V27.41l-3-2.82Zm2.53-22.04v20.3l3 2.82c.3.28.47.68.47 1.09v20.69h12.72V26.76c0-.41.17-.81.47-1.09l3-2.82V2.55H15.17ZM25 38.84c-1.42 0-2.56-1.15-2.56-2.56s1.14-2.56 2.56-2.56 2.56 1.15 2.56 2.56-1.15 2.56-2.56 2.56Zm5.48-21.08H19.76c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5h10.72c.83 0 1.5.68 1.5 1.5s-.67 1.5-1.5 1.5Zm0-6.7H19.76c-.83 0-1.5-.68-1.5-1.5s.67-1.5 1.5-1.5h10.72c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5Zm7.35-8.5V23.5c0 .41-.18.81-.48 1.09l-2.99 2.82v20.04h3.12a4.6 4.6 0 0 0 4.6-4.6V7.14c0-2.42-1.87-4.4-4.25-4.58Z"
                    fill="#98989A"
                  ></path>
                </svg>
              )}
